...
# Use the conda environment we set up in the preamble
...
# Add caching to map_geom
map_geom <- shiny::reactive({
  shiny::req(full_data())
  prep_map_data(full_data())
}) |>
  shiny::bindCache(full_data()) # Cache based on full_data changes
