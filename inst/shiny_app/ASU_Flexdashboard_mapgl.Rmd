...
# Show Data for Selection - remove.  Preview panel now permanent
...
The output directory is displayed below.  To change the output directory, please change the directory through the input box on the *Save and Load Data* tab.
