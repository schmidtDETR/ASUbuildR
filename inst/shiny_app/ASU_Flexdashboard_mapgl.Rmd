...
output$initial_map <- renderMaplibre({
  ...
  maplibre(style = carto_style("positron")) |>
    ...
    add_fill_layer(
      ...
      popup = concat(
        ...
        "<strong>Tract Population: </strong>",number_format(get_column("tract_ASU_unemp"), style = "decimal", maximum_fraction_digits = 0),"<br>",
  ...
  withProgress(message = "Running ASU initialisation…", value = 0, {
    ...
    res <- if (algo_choice == "orig") {
      ...
      run_tract_hunter(tract_list, uploaded_data(),       # <- keep verbose
                       verbose = TRUE)
    }
