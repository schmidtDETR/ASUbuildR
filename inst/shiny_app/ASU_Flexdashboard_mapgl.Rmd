...
shiny::observeEvent(input$update, {
  ...
  # Calculate new color scheme
  color_scheme <- calculate_color_scheme(updated_data)
  
  # Update the fill color dynamically using set_paint_property
  new_color_expr <- mapgl::step_expr(
    column = "asunum",
    base = "#E0E0E0",  # Grey for asunum == 0
