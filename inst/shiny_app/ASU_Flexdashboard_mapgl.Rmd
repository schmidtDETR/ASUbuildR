...
shiny::textOutput("tigris_year")
=======
shiny::textOutput("tract_pop_year")
shiny::textOutput("selected_tract_year")
>>>>>>> 2b4c66bea391a8e266e3ee12af4be20bda5f4e37
```
...
shiny::observeEvent(input$file, {
  ...
  output$tigris_year <- shiny::renderText({
    paste0("Default TIGER File Year is: ", tigris_year())
  })
})
...
<<<<<<< HEAD
  ...
  selected_year <- tigris_year()  # default to year before detected year
