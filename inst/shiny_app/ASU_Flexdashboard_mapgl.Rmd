...
observeEvent(input$process, {
  ...
  data_merge <- tract_list |>
    ...
    #arrange(desc(tract_ASU_urate), desc(tract_ASU_unemp))
  ...
  res <- run_tract_hunter(tract_list, uploaded_data())   # ← new call
}
  
  # 🔧 Ensure geometries are MULTIPOLYGON for maplibregl
  ...
  ## 3. Push results into the reactiveVals already used elsewhere
  ...
  ## 4. Render the summary table shown just under the button -----
